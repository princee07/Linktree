...
sendButton.onclick = function() {
  ...
  var whatsappUrl = "https://api.whatsapp.com/send?phone=9958748482&text=" + encodeURIComponent(message);
...
const texts = ["Hey There!", "I am.... Prince","Tech Enthusiast","Connect with Me","And Explore"];
let count = 0;
let index = 0;
let currentText = "";
let letter = "";
